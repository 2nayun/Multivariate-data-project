...
SDfifa$Position[fifa$Position %in% c("GK")] <- "Goalkeeper"
...
#Dribbling과 HeadingAccuracy(가장 오류율 높음)
klaR::partimat(Position ~ HeadingAccuracy+Dribbling, data=fifa, method="qda")
#Finishing과 StandingTackle(가장 오류율 낮음)
klaR::partimat(Position ~ Finishing+StandingTackle, data=fifa, method="qda")
